...
execute if score #lthc.mage.evlc lthc.mage.data matches 0 run loot spawn ~ ~1 ~ loot lthc.mage:ancient_magic/essences/logical_magic
execute if score #lthc.mage.evlc lthc.mage.data matches 1 run loot spawn ~ ~1 ~ loot lthc.mage:ancient_magic/essences/paradoxal_magic
