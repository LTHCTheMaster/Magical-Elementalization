...
execute at @s positioned ~2 ~ ~ run function lthc.mage:boss_objects/random_tree/random_trees/r0tr01
execute at @s positioned ~ ~ ~-2 run placefeature lthc.mage:tree0
execute at @s positioned ~ ~ ~2 run placefeature lthc.mage:tree0
...
execute at @s positioned ~1 ~ ~-5 run function lthc.mage:boss_objects/random_tree/random_trees/r0tr01
execute at @s positioned ~2 ~ ~-5 run placefeature lthc.mage:tree0
execute at @s positioned ~-1 ~ ~5 run placefeature lthc.mage:tree0
execute at @s positioned ~-2 ~ ~5 run placefeature lthc.mage:tree0
execute at @s positioned ~1 ~ ~5 run placefeature lthc.mage:tree0
...
execute at @s positioned ~-4 ~ ~-3 run function lthc.mage:boss_objects/random_tree/random_trees/r0tr01
...
execute at @s positioned ~-5 ~ ~ run function lthc.mage:boss_objects/random_tree/random_trees/r1tr12
execute at @s positioned ~ ~ ~-3 run placefeature lthc.mage:tree1
execute at @s positioned ~ ~ ~-5 run placefeature lthc.mage:tree1
execute at @s positioned ~3 ~ ~ run placefeature lthc.mage:tree1
execute at @s positioned ~5 ~ ~ run placefeature lthc.mage:tree1
execute at @s positioned ~ ~ ~3 run function lthc.mage:boss_objects/random_tree/random_trees/r1tr12
execute at @s positioned ~ ~ ~5 run placefeature lthc.mage:tree1
...
execute at @s positioned ~4 ~ ~-3 run function lthc.mage:boss_objects/random_tree/random_trees/r1tr12
...
execute at @s positioned ~-7 ~ ~-4 run function lthc.mage:boss_objects/random_tree/can_or_not
execute at @s positioned ~7 ~ ~-4 run function lthc.mage:boss_objects/random_tree/can_or_not
execute at @s positioned ~-7 ~ ~4 run function lthc.mage:boss_objects/random_tree/can_or_not
execute at @s positioned ~7 ~ ~4 run function lthc.mage:boss_objects/random_tree/can_or_not
