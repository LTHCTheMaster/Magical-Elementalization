...
execute if score #lthc.mage.first_run lthc.mage.data matches 1 unless score #lthc.mage.version lthc.mage.data matches 010400 run function lthc.mage:core/loading/first_run/update
