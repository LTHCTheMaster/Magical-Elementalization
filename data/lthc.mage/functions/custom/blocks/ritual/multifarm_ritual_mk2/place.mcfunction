...
setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"translate":"MultiFarm Ritual MK2", "color":"#1d1d1d"}'} replace
tag @s remove lthc.mage.multifarm_ritual_mk2
tag @s add lthc.mage.multifarm_ritual_mk2_placed
