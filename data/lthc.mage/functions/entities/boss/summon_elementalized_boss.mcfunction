...
bossbar set lthc.mage:elementalized_boss max 750
bossbar set lthc.mage:elementalized_boss style notched_10
bossbar set lthc.mage:elementalized_boss value 750
