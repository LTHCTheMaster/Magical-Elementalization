summon pillager ~ ~ ~ {Glowing:1b,CustomNameVisible:1b,LeftHanded:1b,PersistenceRequired:1b,Health:500f,Tags:["global.ignore","lthc.mage.entities.elementalized_boss"],CustomName:'{"translate":"Elementalized Boss","color":"#DDDDDD","bold":true,"underlined":true}',HandItems:[{id:"minecraft:crossbow",Count:1b,tag:{Enchantments:[{id:"minecraft:unbreaking",lvl:10s},{id:"minecraft:multishot",lvl:4s},{id:"minecraft:quick_charge",lvl:4s}],ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b,tag:{Fireworks:{Flight:5b,Explosions:[{Type:1,Flicker:1b,Trail:1b,Colors:[I;16768256,1907997],FadeColors:[I;15658734,10703518]}]}}},{id:"minecraft:arrow",Count:1b},{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionEffects:[{Id:9b,Amplifier:1b,Duration:300,ShowParticles:0b},{Id:25b,Amplifier:1b,Duration:40,ShowParticles:0b}],Potion:"minecraft:empty",CustomPotionColor:14540253}}],Charged:1b}},{}],HandDropChances:[0.000F,0.085F],Attributes:[{Name:"generic.max_health",Base:500},{Name:"generic.knockback_resistance",Base:1},{Name:"generic.armor",Base:0},{Name:"generic.armor_toughness",Base:0}]}
...
bossbar set lthc.mage:elementalized_boss max 500
bossbar set lthc.mage:elementalized_boss style notched_10
bossbar set lthc.mage:elementalized_boss value 500
