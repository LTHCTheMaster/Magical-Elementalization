execute run summon area_effect_cloud ~ ~1 ~ {Tags:["global.ignore","lthc.mage.loot_calculate.mangrove_guardian"],Duration:0}
scoreboard players set #lthc.mage.9 lthc.mage.data 9
execute store result score #lthc.mage.mglc lthc.mage.data run data get entity @e[type=area_effect_cloud,tag=lthc.mage.loot_calculate.mangrove_guardian,limit=1] UUID[0]
...
kill @e[type=area_effect_cloud,tag=lthc.mage.loot_calculate.mangrove_guardian]
