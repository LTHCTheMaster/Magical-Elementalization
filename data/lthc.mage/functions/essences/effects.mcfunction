...
execute if score #lthc.mage.snd lthc.mage.data matches 1 run playsound lthc.mage:essences master @a[distance=..7] ~ ~1 ~ 0.75 1.0 0.45
execute if score #lthc.mage.snd lthc.mage.data matches 2 run playsound lthc.mage:essences2 master @a[distance=..7] ~ ~1 ~ 0.75 1.0 0.45
