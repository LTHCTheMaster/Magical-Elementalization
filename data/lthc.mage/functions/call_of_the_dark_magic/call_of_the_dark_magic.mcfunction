...
execute if score #lthc.mage.cotdm lthc.mage.data matches 0 if predicate lthc.mage:luck/1 run scoreboard players set #lthc.mage.cotdm lthc.mage.data 5
...
execute if score #lthc.mage.cotdm lthc.mage.data matches 4 run function lthc.mage:wands/forest_clearer/raycast

execute if score #lthc.mage.cotdm lthc.mage.data matches 4 if score #lthc.mage.b2 lthc.mage.data matches 0 at @s run function lthc.mage:entities/boss/summon_elementalized_boss
