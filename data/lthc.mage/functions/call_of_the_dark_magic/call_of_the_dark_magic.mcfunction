...
execute if score #lthc.mage.cotdm lthc.mage.data matches 1 anchored eyes run function lthc.mage:call_of_the_dark_magic/internal/1
...
execute if score #lthc.mage.cotdm lthc.mage.data matches 4 run function lthc.mage:call_of_the_dark_magic/internal/4
