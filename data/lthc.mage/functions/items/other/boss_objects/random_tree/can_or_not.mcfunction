...
execute if score #lthc.mage.tcn lthc.mage.data matches 1 run function lthc.mage:items/other/boss_objects/random_tree/random_trees/r0tr01
execute if score #lthc.mage.tcn lthc.mage.data matches 2 run function lthc.mage:items/other/boss_objects/random_tree/random_trees/r1tr12
