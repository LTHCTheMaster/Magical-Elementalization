...
function lthc.mage:items/all_spells/wands/src/logical_wand
...
execute unless score @s lthc.mage.data matches 101 run function lthc.mage:items/all_spells/wands/init/logical_wand/mental_changes
