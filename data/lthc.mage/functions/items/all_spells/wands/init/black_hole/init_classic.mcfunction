...
function lthc.mage:items/all_spells/wands/src/black_hole
...
execute unless score @s lthc.mage.data matches 1 run function lthc.mage:items/all_spells/wands/init/black_hole/mental_changes
