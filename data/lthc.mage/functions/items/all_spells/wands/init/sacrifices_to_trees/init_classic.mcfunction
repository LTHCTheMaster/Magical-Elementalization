...
function lthc.mage:items/all_spells/wands/src/sacrifices_to_trees
...
execute unless score @s lthc.mage.data matches 6 run function lthc.mage:items/all_spells/wands/init/sacrifices_to_trees/mental_changes
