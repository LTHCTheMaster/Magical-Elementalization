...
execute as @e[type=sheep,distance=..10] run function lthc.mage:items/all_spells/spells/compact_color/effect
...
execute unless score @s lthc.mage.data matches 201 run function lthc.mage:items/all_spells/spells/mental_changes
