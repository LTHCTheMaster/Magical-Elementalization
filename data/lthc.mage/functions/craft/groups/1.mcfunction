...
execute if data storage lthc.mage:crafting_altar Item.aero run function lthc.mage:craft/check/compact_aero_essence
# Compact Celestial Essence craft checking
execute if data storage lthc.mage:crafting_altar Item.celestial run function lthc.mage:craft/check/compact_celestial_essence
# Compact Color Essence craft checking
execute if data storage lthc.mage:crafting_altar Item.color run function lthc.mage:craft/check/compact_color_essence
# Compact End Essence craft checking
execute if data storage lthc.mage:crafting_altar Item.end run function lthc.mage:craft/check/compact_end_essence
...
execute if data storage lthc.mage:crafting_altar Item.phyto run function lthc.mage:craft/check/compact_phyto_essence
# Compact Thermo Essence craft checking
execute if data storage lthc.mage:crafting_altar Item.thermo run function lthc.mage:craft/check/compact_thermo_essence
# Compact Phyto Cored craft checking
execute if data storage lthc.mage:crafting_altar Item.compact_phyto run function #lthc.mage:crafts_sub_groups/compact_phyto
# Berserker Staff craft checking
execute if data storage lthc.mage:crafting_altar Item.compact_thermo run function lthc.mage:craft/check/berserker_staff
# Wind Force craft checking
execute if data storage lthc.mage:crafting_altar Item.compact_aero run function lthc.mage:craft/check/wind_force
...
execute if data storage lthc.mage:crafting_altar Item.compact_fungus run function lthc.mage:craft/check/call_of_the_dark_magic
