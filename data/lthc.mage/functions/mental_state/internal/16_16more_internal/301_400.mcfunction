...
execute if score #lthc.mage.tmpms lthc.mage.current_charged matches 0 if predicate lthc.mage:luck/50 run scoreboard players add @s lthc.mage.mental_state 1
