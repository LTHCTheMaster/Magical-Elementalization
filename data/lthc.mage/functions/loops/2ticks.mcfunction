...
execute if score #lthc.mage.lm lthc.mage.data matches 125.. run function lthc.mage:loops/250ticks
scoreboard players add #lthc.mage.lm lthc.mage.current_charged 1
execute if score #lthc.mage.lm lthc.mage.current_charged matches 150.. run function lthc.mage:loops/300ticks
