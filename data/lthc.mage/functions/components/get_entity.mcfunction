...
execute if entity @e[type=glow_item_frame,tag=lthc.mage.compactor_placed,distance=..1,sort=nearest,limit=1] run function lthc.mage:components/compactors/generate_compacting
