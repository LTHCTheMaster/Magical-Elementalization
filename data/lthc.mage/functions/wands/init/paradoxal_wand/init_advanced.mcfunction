...
function lthc.mage:wands/src/paradoxal_wand
...
execute unless score @s lthc.mage.data matches 102 run function lthc.mage:wands/init/paradoxal_wand/mental_changes
