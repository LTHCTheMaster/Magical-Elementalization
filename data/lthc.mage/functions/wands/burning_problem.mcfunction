clear @s command_block{ctc: {traits: {"magic/essences":1b, item:1b, compact_gas:1b}, id: "compact_gas_essence", from: "lthc.mage"}} 1
# Burn things
...
advancement grant @s only lthc.mage:age0_road/age1_road/age2_road/use_magic/burning_problem
# Play the sound
