...
execute as @e[type=#lthc.mage:animals,distance=..10,tag=!global.ignore,tag=!global.ignore.kill] at @s run function lthc.mage:wands/src/sacrifices_to_trees/create_trees
