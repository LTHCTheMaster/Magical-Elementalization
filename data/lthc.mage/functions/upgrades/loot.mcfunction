...
execute if score #lthc.mage.lcou lthc.mage.data matches 4 if entity @s[advancements={lthc.mage:secrets=true}] run loot spawn ~ ~ ~ loot lthc.mage:item/upgrades/secret_upgrade
