...
execute if score #lthc.mage.cotdm lthc.mage.data matches 1 anchored eyes run function lthc.mage:items/all_spells/call_of_the_dark_magic/internal/1

execute if score #lthc.mage:cotdm lthc.mage.data matches 2 run function lthc.mage:items/all_spells/call_of_the_dark_magic/sub_effects/staff_effects

execute if score #lthc.mage.cotdm lthc.mage.data matches 3 run function lthc.mage:items/all_spells/call_of_the_dark_magic/sub_effects/forestian_effect

execute if score #lthc.mage.cotdm lthc.mage.data matches 4 run function lthc.mage:items/all_spells/call_of_the_dark_magic/internal/4
