...
execute if score _defs.players_present lthc.mage._defs matches 1 if score _defs.minecraft_version lthc.mage._defs matches 3337.. run scoreboard players set _defs.checked_version lthc.mage._defs 1
