...
execute if score _defs.checked_version lthc.mage._defs matches 0 run tellraw @a[tag=convention.debug] ["",{"text": "Magical Elementalization Error: ERROR] MC 1.19+ is Required","color": "red","bold": true}]
