...
function lthc.mage:items/all_spells/wands/src/wind_force
...
execute unless score @s lthc.mage.data matches 8 run function lthc.mage:items/all_spells/wands/init/wind_force/mental_changes
