...
function lthc.mage:items/all_spells/wands/src/life_bring
...
execute unless score @s lthc.mage.data matches 5 run function lthc.mage:items/all_spells/wands/init/life_bring/mental_changes
