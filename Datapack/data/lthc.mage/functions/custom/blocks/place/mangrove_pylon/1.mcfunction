...
#Place the custom block
	execute as @e[type=area_effect_cloud,tag=LTHCMage_L,limit=1] at @s run function lthc.mage:custom/blocks/place/mangrove_pylon/2
advancement revoke @s only lthc.mage:system/mangrove_pylon
