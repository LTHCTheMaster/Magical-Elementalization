...
setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"translate":"MultiFarm Ritual MK1", "color":"#1d1d1d"}'} replace
tag @s remove lthc.mage.multifarm_ritual_mk1
tag @s add lthc.mage.multifarm_ritual_mk1_placed
